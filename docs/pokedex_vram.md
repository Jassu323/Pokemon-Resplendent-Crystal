...
With all five future icon rows reserved, this leaves 192 tiles free in VRAM
bank 1: 108 in `vTiles3`, 46 in `vTiles4`, and 38 in `vTiles5`. The CGB
...
timing, slot, and underrun-diagnostic state.
