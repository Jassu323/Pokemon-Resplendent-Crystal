...
DEF BATTLEANIMSTRUCT_FRAMESET_ID     rw ; 03-04 (lo = index, hi = bank selector: 0=regular/bank51, 1=ext/bank63)
...
DEF BATTLEANIM_SMALL_EXT_OAM_CACHE_SLOTS EQU 8
DEF BATTLEANIM_SMALL_EXT_OAM_CACHE_OAMS EQU 2
DEF BATTLEANIM_SMALL_EXT_OAM_CACHE_ENTRY_LENGTH EQU 1 + BATTLEANIM_SMALL_EXT_OAM_CACHE_OAMS * 4
...
; Ext framesets — high byte of BATTLEANIMSTRUCT_FRAMESET_ID = 1 (bank 63)
	const_def $100
