...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLE_ANIM_FRAMESET_ENERGY_BALL           ; ba
	const BATTLE_ANIM_FRAMESET_SEISMIC_TOSS_LIGHT    ; bb
	const BATTLE_ANIM_FRAMESET_MUD_BALL_SMALL        ; bc
	const BATTLE_ANIM_FRAMESET_MUD_BALL_MEDIUM       ; bd
	const BATTLE_ANIM_FRAMESET_MUD_SPLASH            ; be
	const BATTLE_ANIM_FRAMESET_MUD_SPLASH_MEDIUM     ; bf
	const BATTLE_ANIM_FRAMESET_THUNDERSHOCK_STRIKE   ; c0
	const BATTLE_ANIM_FRAMESET_ELECTRICITY_EFFECT    ; c1
...
; BattleAnimOAMData indexes (see data/battle_anims/oam.asm)
	...
	const BATTLE_ANIM_OAMSET_SEISMIC_TOSS_LIGHT
	const BATTLE_ANIM_OAMSET_MUD_BALL_MEDIUM
	const BATTLE_ANIM_OAMSET_MUD_SPLASH_MEDIUM_1
	const BATTLE_ANIM_OAMSET_MUD_SPLASH_MEDIUM_2
	const BATTLE_ANIM_OAMSET_MUD_SPLASH_MEDIUM_3
	const BATTLE_ANIM_OAMSET_MUD_SPLASH_1
	const BATTLE_ANIM_OAMSET_MUD_SPLASH_2
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_1
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_2
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_3
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_4
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_5
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_LOWER_4
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_LOWER_3
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_LOWER_2
	const BATTLE_ANIM_OAMSET_THUNDERSHOCK_STRIKE_LOWER_1
