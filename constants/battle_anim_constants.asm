...
DEF FIRST_BATTLE_ANIM_EXTENSION_FUNC EQU const_value
	const BATTLE_ANIM_FUNC_EXT_NULL                  ; 4f
	const BATTLE_ANIM_FUNC_WISH_STAR                 ; 50
	const BATTLE_ANIM_FUNC_SEISMIC_TOSS_LIGHT        ; 51
	const BATTLE_ANIM_FUNC_MUD_SHOT                  ; 52
	const BATTLE_ANIM_FUNC_AROMATHERAPY_FLOWER       ; 53
	const BATTLE_ANIM_FUNC_OVERHEAT_FLAME            ; 54
	const BATTLE_ANIM_FUNC_THUNDER                   ; 55
...
DEF BATTLE_ANIM_VINE_WHIP_PAL_LOAD    EQU 4
DEF BATTLE_ANIM_VINE_WHIP_PAL_RESTORE EQU 5
