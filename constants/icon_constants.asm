...
DEF POKEDEX_TYPE_ICON_SLOT_1_TILE EQU $4e ; uses $4e-$55 in VRAM bank 1
DEF POKEDEX_TYPE_ICON_SLOT_2_TILE EQU $56 ; uses $56-$5d in VRAM bank 1
DEF POKEDEX_TYPE_ICON_SINGLE_X EQU 11
DEF POKEDEX_TYPE_ICON_SLOT_1_X EQU 9
DEF POKEDEX_TYPE_ICON_SLOT_2_X EQU 14
DEF POKEDEX_TYPE_ICON_Y EQU 1
DEF POKEDEX_TYPE_ICON_SLOT_1_ATTR EQU $0e ; VRAM bank 1, BG palette 6
DEF POKEDEX_TYPE_ICON_SLOT_2_ATTR EQU $0f ; VRAM bank 1, BG palette 7

DEF POKEDEX_SEARCH_TYPE_ICON_X EQU 11
DEF POKEDEX_SEARCH_TYPE_1_ICON_Y EQU 4
DEF POKEDEX_SEARCH_TYPE_2_ICON_Y EQU 6
