...
; move priorities, biased so unsigned comparisons preserve turn order
DEF MOVE_PRIORITY_MINUS_7 EQU 0
DEF MOVE_PRIORITY_MINUS_6 EQU 1
DEF MOVE_PRIORITY_MINUS_5 EQU 2
DEF MOVE_PRIORITY_MINUS_4 EQU 3
DEF MOVE_PRIORITY_MINUS_3 EQU 4
DEF MOVE_PRIORITY_MINUS_2 EQU 5
DEF MOVE_PRIORITY_MINUS_1 EQU 6
DEF MOVE_PRIORITY_0       EQU 7
DEF MOVE_PRIORITY_PLUS_1  EQU 8
DEF MOVE_PRIORITY_PLUS_2  EQU 9
DEF MOVE_PRIORITY_PLUS_3  EQU 10
DEF MOVE_PRIORITY_PLUS_4  EQU 11
DEF MOVE_PRIORITY_PLUS_5  EQU 12
DEF BASE_PRIORITY EQU MOVE_PRIORITY_0

; move attribute flags
DEF MOVE_ATTR_CONTACT_F EQU 0
DEF MOVE_ATTR_WIND_F    EQU 1
DEF MOVE_ATTR_POWDER_F  EQU 2
DEF MOVE_ATTR_PUNCH_F   EQU 3

DEF MOVE_ATTR_CONTACT EQU 1 << MOVE_ATTR_CONTACT_F
DEF MOVE_ATTR_WIND    EQU 1 << MOVE_ATTR_WIND_F
DEF MOVE_ATTR_POWDER  EQU 1 << MOVE_ATTR_POWDER_F
DEF MOVE_ATTR_PUNCH   EQU 1 << MOVE_ATTR_PUNCH_F
...
; wBattleCommandFlags bits.
	...
	const BATTLE_EXTCMD_MULTI_STAT_UP
	const BATTLE_EXTCMD_SELF_STAT_DROP_HIT
	const BATTLE_EXTCMD_CURSE
	...
	const BATTLE_EXTCMD_BRICK_BREAK_ANIM
	...
	const BATTLE_EXTCMD_EAT_TARGET_BERRY
	const BATTLE_EXTCMD_ICE_BALL_POWER

	const_def
	const BATTLE_CORE_HOOK_BEFORE_ACTION
	const BATTLE_CORE_HOOK_AFTER_ACTION
	const BATTLE_CORE_HOOK_BETWEEN_TURNS
	const BATTLE_CORE_HOOK_SWITCH_OUT
	const BATTLE_CORE_HOOK_SWITCH_IN
	const BATTLE_CORE_HOOK_CAN_SWITCH
	const BATTLE_CORE_HOOK_RUN_CHECK

	const_def
	const BATTLE_ABILITY_HOOK_CHECK_HIT
	const BATTLE_ABILITY_HOOK_DAMAGE_MODIFIER
	const BATTLE_ABILITY_HOOK_AFTER_DAMAGE
...
; wPlayerSubStatus2 or wEnemySubStatus2 bit flags
	...
	const SUBSTATUS_DEFENSE_CURL_PENDING
	const SUBSTATUS_ICE_BALL_BOOST
