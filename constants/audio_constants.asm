...
DEF SAMPLED_CRY_BATTLE_PREFILL_BLOCKS EQU 0
DEF SAMPLED_CRY_PREPARED_REFILL_FRAMES EQU 6
DEF SAMPLED_CRY_CACHE_REFILL_BLOCKS EQU 8
DEF SAMPLED_CRY_COMPRESSED_BLOCK_SIZE EQU 9
DEF SAMPLED_CRY_MINMAX2_BIT_LEVELS_SIZE EQU $400
