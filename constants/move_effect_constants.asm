; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_CURSE
	const EFFECT_SELF_STAT_DROP_HIT
	...
	const EFFECT_RECOIL_HIT_1_3
	const EFFECT_BURN
	const EFFECT_FANG_HIT
	...
	const EFFECT_HEX
	const EFFECT_YAWN
	const EFFECT_EAT_BERRY_HIT
	const EFFECT_ICE_BALL
