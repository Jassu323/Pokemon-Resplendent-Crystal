...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const BLAST_BURN   ; 10c
	const HYDRO_CANNON ; 10d
	const METEOR_MASH  ; 10e
	const AROMATHERAPY ; 10f
	const AIR_CUTTER   ; 110
	const OVERHEAT     ; 111
	const ROCK_TOMB    ; 112
	const SILVER_WIND  ; 113
	const EXTRASENSORY ; 114
	const SKY_UPPERCUT ; 115
	const SAND_TOMB    ; 116
	const BULLET_SEED  ; 117
	const AERIAL_ACE   ; 118
	const ICICLE_SPEAR ; 119
	const BLOCK        ; 11a
	const HOWL         ; 11b
	const DRAGON_CLAW  ; 11c
	const FRENZY_PLANT ; 11d
	const BULK_UP      ; 11e
	const MUD_SHOT     ; 11f
	const POISON_TAIL  ; 120
	const MAGICAL_LEAF ; 121
	const CALM_MIND    ; 122
	const DRAGON_DANCE ; 123
	const ROCK_BLAST   ; 124
	const SHOCK_WAVE   ; 125
	const WATER_PULSE  ; 126
	const PLUCK        ; 127
	const SUCKER_PUNCH ; 128
	const FORCE_PALM   ; 129
	const POISON_JAB   ; 12a
	const NIGHT_SLASH  ; 12b
	const X_SCISSOR    ; 12c
	const BUG_BUZZ     ; 12d
	const DRAIN_PUNCH  ; 12e
	const ENERGY_BALL  ; 12f
	const BULLET_PUNCH ; 130
	const THUNDER_FANG ; 131
	const ICE_FANG     ; 132
	const FIRE_FANG    ; 133
	const SHADOW_SNEAK ; 134
	const MUD_BOMB     ; 135
	const LAVA_PLUME   ; 136
	const STONE_EDGE   ; 137
	const BUG_BITE     ; 138
	const OMINOUS_WIND ; 139
