...
; BATTLE_ANIM_OBJ_MUD_BALL
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_MUD_BALL, BATTLE_ANIM_FUNC_MUD_SHOT, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_MUD_BALL
