...
rept NUM_POKEMON
	...
	elif sampled_cry_mon == MANECTRIC
	...
	elif sampled_cry_mon == LOPUNNY
		db SAMPLED_CRY_LOPUNNY
	...
	elif sampled_cry_mon == GARCHOMP
		db SAMPLED_CRY_GARCHOMP
	...
	elif sampled_cry_mon == MAMOSWINE
...
SECTION "Sampled Cry Payloads 20", ROMX

GlaceonSampledCry::
	dw (GlaceonSampledCryEnd - GlaceonSampledCryData) / 9
GlaceonSampledCryData:
...
MamoswineSampledCry::
	dw (MamoswineSampledCryEnd - MamoswineSampledCryData) / 9
MamoswineSampledCryData:
	INCBIN "audio/sampled_cries/mamoswine.mm2"
MamoswineSampledCryEnd:
	assert (MamoswineSampledCryEnd - MamoswineSampledCryData) % 9 == 0


SECTION "Sampled Cry Payloads 21", ROMX

PorygonZSampledCry::
	dw (PorygonZSampledCryEnd - PorygonZSampledCryData) / 9
PorygonZSampledCryData:
...
SkittySampledCry::
	dw (SkittySampledCryEnd - SkittySampledCryData) / 9
SkittySampledCryData:
	INCBIN "audio/sampled_cries/skitty.mm2"
SkittySampledCryEnd:
	assert (SkittySampledCryEnd - SkittySampledCryData) % 9 == 0

DelcattySampledCry::
	dw (DelcattySampledCryEnd - DelcattySampledCryData) / 9
DelcattySampledCryData:
...
ManectricSampledCry::
	dw (ManectricSampledCryEnd - ManectricSampledCryData) / 9
ManectricSampledCryData:
	INCBIN "audio/sampled_cries/manectric.mm2"
ManectricSampledCryEnd:
	assert (ManectricSampledCryEnd - ManectricSampledCryData) % 9 == 0

RoseliaSampledCry::
	dw (RoseliaSampledCryEnd - RoseliaSampledCryData) / 9
RoseliaSampledCryData:
...
LopunnySampledCry::
	dw (LopunnySampledCryEnd - LopunnySampledCryData) / 9
LopunnySampledCryData:
	INCBIN "audio/sampled_cries/lopunny.mm2"
LopunnySampledCryEnd:
	assert (LopunnySampledCryEnd - LopunnySampledCryData) % 9 == 0
...
GarchompSampledCry::
	dw (GarchompSampledCryEnd - GarchompSampledCryData) / 9
GarchompSampledCryData:
