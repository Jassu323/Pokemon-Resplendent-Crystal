; Pulled via this Tutorial:  https://github.com/pret/pokecrystal/wiki/Add-a-new-party-menu-icon
; Which uses art assets from a few places, including:
; http://www.pokecommunity.com/showthread.php?t=338470 by Blue Emerald, Soloo993, Chamber, Lake, Neslug, Pikachu253, and Ryta
; Polished Crystal
; and LuigiTKO
; Icons were mixed and matched, though most come from the PC thread
